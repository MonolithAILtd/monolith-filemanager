...
three_d_packages = ["gmsh>=4.9.0", "pyvista>=0.34.2", "cqkit>=0.5.1"]
matlab_packages = ["scipy>=1.4.1"]

all_packages = ['h5py>=2.10.0', 'joblib>=0.15.0', 'numpy>=1.20.3', 'pandas>=1.5.3',
                'distributed>=2021.1.1', 'dill>=0.2.9', 'pyyaml>=5.1.2', 'boto3>=1.10.5', 'botocore>=1.13.5',
                'requests>=2.22.0', 'openpyxl>=3.0.7', 'pyarrow>=1.0.1', 'xlwt>=1.3.0', 'xlrd>=1.2.0',
