...
class TestStandardPickleFile(TestCase):
    ...
    @patch("general_filemanager.file.standard_pickle_file.File.__init__")
    def test___init__(self, mock_file):
        StandardPickleFile(path="test")
        mock_file.assert_called_once_with(path="test")

    @patch("general_filemanager.file.standard_pickle_file.pickle")
    @patch("general_filemanager.file.standard_pickle_file.open")
    @patch("general_filemanager.file.standard_pickle_file.StandardPickleFile.__init__")
