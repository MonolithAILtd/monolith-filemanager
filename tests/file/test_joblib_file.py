...
class TestJoblibFile(unittest.TestCase):
    ...
    @patch("general_filemanager.file.joblib_file.File.__init__")
    ...
    @patch("general_filemanager.file.joblib_file.joblib.load")
    @patch("general_filemanager.file.joblib_file.JoblibFile.__init__")
    ...
    @patch("general_filemanager.file.joblib_file.joblib.dump")
    @patch("general_filemanager.file.joblib_file.JoblibFile.__init__")
